...
from tool_monkey import retry_exhaustion

sys.path.insert(0, str(Path(__file__).parent.parent))

from agent_runtime.shared.utils.lib import format_prompt
from agent_runtime.shared.agent_runtime import AgentRuntimeWithRetries
...
if __name__ == "__main__":
    ...
    failure_scenarios = {"fetch_logs": retry_exhaustion(num_failures=3, seconds=2)
                         }
    agent_runtime = AgentRuntimeWithRetries(llm_provider, tool_registry, tool_config={
        "fetch_logs": {
    ...
    }, failure_scenarios=failure_scenarios, max_tool_retries=2, )
