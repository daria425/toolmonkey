...
from tool_monkey import progressive_timeout
...
if __name__ == "__main__":
    ...
    failure_scenarios = {
        "fetch_logs": progressive_timeout(delays=[1.0, 2.0, 4.0])}
    ...
    }, failure_scenarios=failure_scenarios, max_tool_retries=4, retry_delay=0.0)
